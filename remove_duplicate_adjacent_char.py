...
move.  The result of this move is that the string is "aaca", of which only "aa" is possible, so the final string
is "ca".
Example 2:
...
class TestRemoveDuplicates(TestCase):
    ...
    def test_remove_duplicates(self) -> None:
        obj = Solution()
        self.assertEqual("ca", obj.removeDuplicates(self.str))
