...
class TestAccountsMerge(TestCase):
    def setUp(self) -> None:
        self.accounts_1 = [["John", "johnsmith@mail.com", "john_newyork@mail.com"],
                           ["John", "johnsmith@mail.com", "john00@mail.com"], ["Mary", "mary@mail.com"],
                           ["John", "johnnybravo@mail.com"]]

    def test_accounts_merge(self) -> None:
        obj = Solution()
        self.assertListEqual(obj.accountsMerge(self.accounts_1), [['John', 'john00@mail.com', 'john_newyork@mail.com',
